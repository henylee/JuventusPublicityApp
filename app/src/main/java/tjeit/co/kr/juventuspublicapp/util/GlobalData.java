...
public class GlobalData {
    ...
    public static void addNews() {
        ...
        ContextUtil.news.add(new News("http://uimg.7mkr.com/data/news/20170913/094531nm4ylxdjj91505267131991192.jpg","'메시 원맨쇼' 바르사, 안방서 유벤투스 3-0으로 격파..완벽한 복수",
                "FC바르셀로나가 유벤투스를 제압하고 지난 시즌 당한 패배를 되갚았다.\n바르셀로나는 13일 새벽 3시 45분(한국시간) 스페인 바르셀로나에 위치한 캄 노우서 열린 유벤투스와 2017-18시즌 유럽축구연맹(UEFA) 챔피언스리그 조별리그 D조 1차전서 3-0으로 승리를 거뒀다. 이 경기 승리로 바르셀로나는 지난 시즌 UCL 8강에서 당한 패배 복수에 성공했다. 또한, 올 시즌 챔피언스리그에서 쾌조의 출발을 했다." +
